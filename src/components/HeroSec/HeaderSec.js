...
function HeaderSec() {
    return(
        <header>
            <a href="/" className="logo">Material Kit 2</a>
            <div className="d-flex">
                <ul className="nav">
                    <li>
                        <a href="#">
                            <svg fill="#344767" viewBox="0 0 256 256" id="Flat" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li>
                        <a href="#">
                            <svg className="MuiSvgIcon-root MuiSvgIcon-fontSizeInherit css-1amtie4" focusable="false" viewBox="0 0 24 24"
                                aria-hidden="true" data-testid="GitHubIcon">
                                <path
                ...
                <a className="btn" href="#">Free Download</a>
            </div>
        </header>
    )
}
